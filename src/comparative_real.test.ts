...
describe('╚══════════════════════════════════════════════════════════════════════════════╝', () => {
    ...
    describe('📗 TEST 1: Respuesta CORRECTA', () => {
        ...
        it('🐢 TRADICIONAL (con LLM) - Verifica respuesta correcta', async () => {
            console.log(`\n  ════════════════════════════════════════════════════`);
        ...
        it('📊 COMPARACIÓN - Respuesta correcta', () => {
            console.log(`\n  ╔════════════════════════════════════════════════════╗`);
    ...
    describe('📕 TEST 2: ALUCINACIÓN (10000mg)', () => {
        ...
        it('🐢 TRADICIONAL (con LLM) - Detecta alucinación', async () => {
            console.log(`\n  ════════════════════════════════════════════════════`);
        ...
        it('📊 COMPARACIÓN - Detección de alucinación', () => {
            console.log(`\n  ╔════════════════════════════════════════════════════╗`);
