    ...
    return (
        <aside className="w-64 border-r border-gray-100 bg-white fixed h-full z-20 hidden md:flex flex-col">
            ...
            <nav className="flex-1 p-6 space-y-2">
                ...
                <NavItem href="/vaccines" icon={ShieldCheck} label="Vaccine Vault" active={pathname === '/vaccines'} />
                <NavItem href="/expert" icon={Award} label="Expert Identity" active={pathname === '/expert'} />
