            ...
            >
                <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <p className="text-gray-400 text-sm mt-1 text-center">Join the Neural Bridge network</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-black/50 border border-white/5 rounded-xl py-3 pl-10 pr-4 text-white placeholder:text-gray-700 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 transition-all text-sm"
                            ...
                            <div className="space-y-1">
                                <label className="text-xs uppercase tracking-widest font-semibold text-gray-500 ml-1">Handle</label>
                                <div className="relative">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3 rounded-xl transition-all shadow-[0_0_20px_rgba(0,242,255,0.2)] flex items-center justify-center group mt-4"
                        >
                            {isLoading ? (
                    ...
                    <p className="text-center text-gray-500 text-sm mt-8">
                        ...
                        <Link href="/login" className="text-cyan-400 hover:text-cyan-300 transition-colors font-medium">Log in</Link>
                    </p>
                </div>
            </motion.div>
        </div>
