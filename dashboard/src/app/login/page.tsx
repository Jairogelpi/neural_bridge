            ...
            <div className="w-full max-w-md">
                ...
                >
                    <div className="flex flex-col items-center mb-10">
                        <div className="w-16 h-16 bg-gradient-to-tr from-blue-600 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 shadow-xl shadow-blue-500/20">
                            <Shield className="w-8 h-8 text-white" />
                        </div>
                        <h1 className="text-3xl font-black italic tracking-tighter text-gray-900">SENTINEL ACCESS</h1>
                        <p className="text-xs font-bold uppercase tracking-widest text-gray-400 mt-2">Enter the sovereign lattice</p>
                    </div>
                    ...
                    <p className="text-center mt-8 text-xs font-medium text-gray-400">
                        New Sentinel? <Link href="/register" className="text-blue-600 hover:text-blue-700 font-bold ml-1">Initialize Protocol</Link>
                    </p>
                </motion.div>
            </div>
        </div>
