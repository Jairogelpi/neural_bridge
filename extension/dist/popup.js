...
function updateCrystalDisplay(crystal) {
...
async function handleCopy() {
  ...
  setTimeout(() => btn.textContent = "Copy Crystal Data", 2e3);
}
...
async function loadMetrics() {
  ...
  statTokens.innerHTML = `${(tokens / 1e3).toFixed(1)}<span class="metric-unit">K Tokens</span>`;
